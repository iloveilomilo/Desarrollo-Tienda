            ...
            <form action="<?= base_url('admin/perfil/actualizar') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center mb-4 d-flex flex-column align-items-center justify-content-center border-end">
                        ...
                        ?>
                        <img src="<?= base_url('uploads/perfiles/' . $foto) ?>" id="preview_foto" alt="Foto de perfil"
                            class="rounded-circle mb-3 shadow-sm border border-3 border-white"
                            style="width: 150px; height: 150px; object-fit: cover;">
                        <label class="btn btn-outline-primary btn-sm rounded-pill px-3" style="cursor:pointer">
