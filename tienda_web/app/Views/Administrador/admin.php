            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 fw-bold text-dark">$<?= number_format($ingresos ?? 0, 2) ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 fw-bold text-dark"><?= $ordenes_pendientes ?? 0 ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 fw-bold text-dark"><?= $productos_activos ?? 0 ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 fw-bold text-dark"><?= $clientes_total ?? 0 ?></div>
                    </div>
                    <div class="col-auto">
                            ...
                            <?php if (!empty($ordenes_recientes)): ?>
                                <?php foreach ($ordenes_recientes as $orden): ?>
                                    <tr>
                                        ...
                                        <td class="py-3"><?= esc($orden['nombre'] . ' ' . $orden['apellidos']) ?></td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-5">
                                        <i class="fas fa-inbox fa-3x mb-3 text-light d-block"></i>Aún no hay ventas registradas.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body text-center py-4">
                ...
                <?php else: ?>
                    <div class="alert alert-success border-0 w-100 py-4">
                        <div class="mb-3">
                            <i class="fas fa-check-circle text-success fa-3x"></i>
                        </div>
                        <h6 class="fw-bold text-success mb-1">¡Excelente!</h6>
                        <p class="text-success mb-0 small">No tienes chats pendientes.<br>Todo en orden.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <ul class="list-group list-group-flush">
                    <?php if (!empty($stock_bajo)): ?>
                        <?php foreach ($stock_bajo as $item): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                                <div>
                                    <h6 class="mb-0 fw-bold"><?= esc($item['nombre']) ?></h6>
                    ...
                    <?php else: ?>
                        <li class="list-group-item text-center text-muted py-4 border-0">
                            <i class="fas fa-box text-success mb-2 opacity-50 fa-2x d-block"></i>
