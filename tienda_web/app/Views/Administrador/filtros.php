    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (modalDesactivar) {
            modalDesactivar.addEventListener('show.bs.modal', function(event) {
                document.getElementById('btnEjecutarDesactivarFiltro').setAttribute('href', event.relatedTarget.getAttribute('data-url'));
            });
        }
        ...
        if (modalReactivar) {
            modalReactivar.addEventListener('show.bs.modal', function(event) {
                document.getElementById('btnEjecutarReactivarFiltro').setAttribute('href', event.relatedTarget.getAttribute('data-url'));
            });
        }
    });
</script>
