    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (modalDesactivar) {
            modalDesactivar.addEventListener('show.bs.modal', function(event) {
                document.getElementById('btnEjecutarDesactivarCat').setAttribute('href', event.relatedTarget.getAttribute('data-url'));
            });
        }
        ...
        if (modalReactivar) {
            modalReactivar.addEventListener('show.bs.modal', function(event) {
                document.getElementById('btnEjecutarReactivarCat').setAttribute('href', event.relatedTarget.getAttribute('data-url'));
            });
        }
    });
</script>
