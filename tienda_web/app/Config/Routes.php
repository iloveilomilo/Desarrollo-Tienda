...
// =================================================================
// Rutas del Panel de Administración (protegidas por adminAuth)
// =================================================================
$routes->group('admin', ['namespace' => 'App\Controllers\Administrador', 'filter' => 'adminAuth'], function ($routes) {
    ...
    // Soporte interno (admin ↔ agentes de Atención al Cliente)
...
// =================================================================
// Rutas del Portal del Cliente (protegidas por clienteAuth)
// =================================================================
...
// Soporte al Cliente (enviar dudas y ver chat)
...
// =================================================================
// Rutas de Atención al Cliente (protegidas por soporteAuth)
// =================================================================
$routes->group('soporte', ['namespace' => 'App\Controllers\Soporte', 'filter' => 'soporteAuth'], function ($routes) {
    $routes->get('soporte',              'Soporte::index');   // /soporte/soporte → panel principal
    $routes->get('panel',               'Soporte::index');   // alias limpio
